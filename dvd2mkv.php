...
if ($cont == 1) {
	...
	if ($dvd_type == 1) {
		while ($i <= $num_items) {
			...
			fwrite($batfile, "ECHO Encoding the first pass of episode " . $ep_num[$i] . ": " . $episode_title[$i] . "...\r\n");
			fwrite($batfile, "\"" . $xv_loc . "\" -i \"" . $avs_dest[$i] . "\" -type 2 -o \"" . $pass_dest[$i] . "\" -pass1 \"" . $stat_dest[$i] . "\" -framerate 23.976 -progress 24\r\n");
			fwrite($batfile, "ECHO Encoding the second pass of episode " . $ep_num[$i] . ": " . $episode_title[$i] . "...\r\n");
		...
		fwrite($batfile, "ECHO Encoding the first pass of " . $content_title . "...\r\n");
		fwrite($batfile, "\"" . $xv_loc . "\" -i \"" . $avs_dest[1] . "\" -type 2 -o \"" . $pass_dest[1] . "\" -pass1 \"" . $stat_dest[1] . "\" -framerate 23.976 -progress 24\r\n");
		fwrite($batfile, "ECHO Encoding the second pass of " . $content_title . "...\r\n");
